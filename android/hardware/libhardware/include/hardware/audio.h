...
#define AUDIO_HARDWARE_MODULE_ID_EXTERNAL "external"
...
/* Power state */
#define AUDIO_PARAMETER_KEY_POWER_STATE "power_state"
...
// for karaok app ,set audio priority
#define AUDIO_PARAMETER_DEVICES_SETPROP    "setprop"
...
#define AUDIO_PARAMETER_RAW_DATA_OUT "raw_data_output"
/* add by chenjd, 2014.01.11 start--{{{{
 * define parameter name of multi audio management
 */
