...
// sockets is in
...
#elif defined BCMDHD_AP6335_WIFI_USED
    /* AP6335 sdio wifi */
    #ifndef WIFI_DRIVER_MODULE_PATH
    ...
    #endif
    #ifndef WIFI_DRIVER_MODULE_ARG
    #define WIFI_DRIVER_MODULE_ARG          "nvram_path=/system/vendor/modules/nvram_ap6335.txt \
	config_path=/system/vendor/modules/config_ap6335.txt"
    #endif	
...
int wifi_load_driver()
{
    ...
    if (insmod(DRIVER_MODULE_PATH, DRIVER_MODULE_ARG) < 0) {
		...
		wifi_scan_device(0);   //add by wxh
		wifi_power_off();      //add by wxh
        return -1;
    }
...
int wifi_load_driver()
{
    ...
    if (wifi_change_driver_state(WIFI_DRIVER_STATE_ON) < 0)
        return -1;
#endif
	ALOGD("property_set DRIVER_PROP_NAME ok !!!!!!!\n");
    property_set(DRIVER_PROP_NAME, "ok");
    return 0;
#endif
}
