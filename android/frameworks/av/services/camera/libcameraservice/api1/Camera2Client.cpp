...
#ifdef WATERMARK
status_t Camera2Client::setWaterMarkMultiple(const String8& mWaterMark, int dispMode){
    return OK;
}
#endif


void Camera2Client::setAnalogInputColor(int brightness,int contrast,int saturation)
{
