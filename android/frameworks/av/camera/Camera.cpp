...
void Camera::setAnalogInputColor(int brightness,int contrast,int saturation)
{
    ALOGV("setAnalogInputColor");
    sp <ICamera> c = mCamera;
    if (c == 0) return;
    c->setAnalogInputColor(brightness,contrast,saturation);
}
// stop preview mode
...
#ifdef WATERMARK
/*
* Allwinnertech setWaterMarkMultiple
* overlay number or words on the image
* 20160114
*/
