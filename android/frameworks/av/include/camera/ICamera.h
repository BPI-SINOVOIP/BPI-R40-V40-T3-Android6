...
public:
...
#ifdef WATERMARK
		//for watermark
		virtual status_t		setWaterMarkMultiple(const String8& mWaterMark, int dispMode) = 0;
#endif
	...
	virtual void        setAnalogInputColor(int brightness,int contrast,int saturation)=0;
};
