 ...
 * All rights reserved.
 *
 * File : xplayerdemo.cpp
 * Description : xplayerdemo
 * History :
 *
 */
                ...
                if(videodata)
                {
                    if(videodata->ePixelFormat == VIDEO_PIXEL_FORMAT_YUV_MB32_420)
                    {
                        ...
                        if(outFp != NULL)
                        {
                            ...
                            fwrite(videodata->pData0, videodata->nWidth*videodata->nHeight,
                                            1, outFp);
                            fwrite(videodata->pData1, videodata->nWidth*height64Align/2,
                                            1, outFp);
                            fclose(outFp);
                        }
                    }
