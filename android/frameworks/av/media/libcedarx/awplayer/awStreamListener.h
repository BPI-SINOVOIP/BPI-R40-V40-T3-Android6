...
{
    awStreamListener(const sp<IStreamSource> &source, ALooper::handler_id targetID,
                    size_t numBuffers = kNumBuffers, size_t bufferSize = kBufferSize);
