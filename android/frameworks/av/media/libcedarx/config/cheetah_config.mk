...
ENABLE_MEDIA_BOOST_MEM := 0
ENABLE_MEDIA_BOOST_CPU := 1
ENABLE_MEDIA_BOOST_UARTLOG := 1
...
#We surpport display subtitle in cedarx on android4.2 ,4.4 and 5.x now.
#but only use this function in cmcc.

ifeq ($(CONFIG_OS_VERSION),$(OPTION_OS_VERSION_ANDROID_5_0))
	ifeq ($(CONFIG_CMCC), $(OPTION_CMCC_YES))
		ENABLE_SUBTITLE_DISPLAY_IN_CEDARX := 1
	else
		ENABLE_SUBTITLE_DISPLAY_IN_CEDARX := 0
	endif
else ifeq ($(CONFIG_OS_VERSION),$(OPTION_OS_VERSION_ANDROID_6_0))
...
########## configure ENABLE_MEDIA_BOOST_MEM ##########
LOCAL_CFLAGS += -DENABLE_MEDIA_BOOST_MEM=$(ENABLE_MEDIA_BOOST_MEM)
########## configure ENABLE_MEDIA_BOOST_CPU ##########
LOCAL_CFLAGS += -DENABLE_MEDIA_BOOST_CPU=$(ENABLE_MEDIA_BOOST_CPU)
########## configure ENABLE_MEDIA_BOOST_UARTLOG ##########
LOCAL_CFLAGS += -DENABLE_MEDIA_BOOST_UARTLOG=$(ENABLE_MEDIA_BOOST_UARTLOG)
