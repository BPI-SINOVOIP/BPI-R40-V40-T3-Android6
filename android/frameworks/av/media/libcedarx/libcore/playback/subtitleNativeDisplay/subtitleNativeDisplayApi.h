...
enum SUB_ENCODING_TYPE
{
    ...
    SUB_ENCODING_BITMAP  = SUB_CHARSET_BITMAP,
                           // subtitle encode type is bitmap, 4 colors supported.
    ...
    SUB_ENCODING_ANSI    = SUB_CHARSET_UTF_8,
                           // subtitle encode type is text, unknown character encode type
    SUB_ENCODING_
};
