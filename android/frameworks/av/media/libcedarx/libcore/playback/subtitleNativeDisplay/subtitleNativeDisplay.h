...
namespace android
{
   ...
   {
      public:
         CedarXSub(int index, int userSetFontColor, int userSetFontSize, int userSetFontStyle,
                 int userSetYpercent);
         ~CedarXSub();
         ...
         int             getFontStyle();
            int                 setTextBox(sub_item_inf* sub_info, int count,int startx,int starty,
                                      int endx, int endy, int lastDispx, int lastDispy,
                                      int yPercent);
            ...
            int                 setSubInf(sub_item_inf *sub_info,int startx, int starty, int endx,
                                    int endy, int lastDispx, int lastDispy, int newSubShowFlag,
                                    int yPercent);
