...
int PlayerReset(Player* pl, int64_t nSeekTimeUs = 0);
...
int PlayerConfigDispSubTitleInner(Player* pl, int bEnable);
#endif
//********************************  END  ***********************************//
