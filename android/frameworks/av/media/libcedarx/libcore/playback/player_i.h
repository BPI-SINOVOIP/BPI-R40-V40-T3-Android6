...
// if pts difference is more than 17 seconds, we judge there is a pts jump(loop back) event.
#define CONFIG_THREASHOLD_OF_PTS_DIFFERENCE_TO_JUDGE_PTS_jUMP   (17000000)
 ...
 */
#define CONFIG_MAX_WAIT_TIME_FOR_SYNC                           (17000000)
