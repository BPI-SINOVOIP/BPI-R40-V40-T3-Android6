...
public class WifiStateMachine extends StateMachine implements WifiNative.WifiPnoEventHandler,
    ...
    */
	...
	IpConfiguration.IpAssignment a= ret.getIpConfiguration().getIpAssignment();
	if(a == null)
	{
		ret.getIpConfiguration().setIpAssignment(IpConfiguration.IpAssignment.DHCP);
		Log.d(TAG,"++++++++++ a.name()= " + ret.getIpConfiguration().getIpAssignment());

	}
	IpConfiguration.ProxySettings b= ret.getIpConfiguration().getProxySettings();
	if(b == null)
	{
		ret.getIpConfiguration().setProxySettings(IpConfiguration.ProxySettings.NONE);
		Log.d(TAG,"++++++++++ a.name()= " + ret.getIpConfiguration().getProxySettings());
