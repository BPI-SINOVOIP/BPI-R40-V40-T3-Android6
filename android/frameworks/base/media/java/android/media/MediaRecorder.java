...
public class MediaRecorder
{
    ...
    public MediaRecorder() {
        ...
        native_setup(new WeakReference<MediaRecorder>(this), packageName,
                ActivityThread.currentOpPackageName(),0);
    }

	public MediaRecorder(int type) {
         ...
         */
        native_setup(new WeakReference<MediaRecorder>(this), packageName,
                ActivityThread.currentOpPackageName(),type);
    }
	...
	public void setNextSaveFile(String filename) throws IllegalStateException, IOException
    {
        if (filename != null) {
            FileOutputStream fos = new FileOutputStream(filename);
            try {
                _setNextSaveFile(fos.getFD());
            } finally {
                fos.close();
            }
        } 
    ...
    private native final void native_setup(Object mediarecorder_this,
            String clientName, String opPackageName,int type) throws IllegalStateException;
	...
	private native void _setNextSaveFile(FileDescriptor fd);
	//fengyun add avc package end
