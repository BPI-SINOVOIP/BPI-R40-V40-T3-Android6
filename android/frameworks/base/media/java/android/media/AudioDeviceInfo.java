...
public final class AudioDeviceInfo {
    ...
    public static final int TYPE_EXTERNAL               = 21;
   ...
   /**
    ...
    static {
	 ...
	 INT_TO_EXT_DEVICE_MAPPING.put(AudioSystem.DEVICE_OUT_EXTERNAL, TYPE_EXTERNAL);
	 ...
	 EXT_TO_INT_DEVICE_MAPPING.put(TYPE_EXTERNAL, AudioSystem.DEVICE_OUT_EXTERNAL);
    }
}
