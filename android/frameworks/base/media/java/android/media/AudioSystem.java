...
public class AudioSystem
{
    ...
    public static final int STREAM_EXTERNAL = 9;
    /* @hide The audio stream for text to speech (TTS) */
    public static final int STREAM_TTS = 10;
    /**
    ...
    public static final int DEVICE_OUT_EXTERNAL = 0x1000000;
    ...
    public static final String DEVICE_OUT_EXTERNAL_NAME = "external";
	...
	case DEVICE_OUT_EXTERNAL:
            return DEVICE_OUT_EXTERNAL_NAME;
