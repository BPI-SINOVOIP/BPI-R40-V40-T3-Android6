...
android_media_MediaRecorder_native_setup(JNIEnv *env, jobject thiz, jobject weak_this,
                                         jstring packageName, jstring opPackageName,int type)
{
    ALOGV("setup");

    ScopedUtfChars opPackageNameStr(env, opPackageName);

    sp<MediaRecorder> mr = new MediaRecorder(String16(opPackageNameStr.c_str()),type);
    if (mr == NULL) {
...
//fengyun add avc package start

static void
android_media_MediaRecorder_setNextSaveFile(JNIEnv *env, jobject thiz, jobject fileDescriptor)
{
	ALOGV("setNextSaveFile()");
    if (fileDescriptor == NULL) {
        jniThrowException(env, "java/lang/IllegalArgumentException", NULL);
        return;
    }
	int fd = jniGetFDFromFileDescriptor(env, fileDescriptor);
	sp<MediaRecorder> mr = getMediaRecorder(env, thiz);
	process_media_recorder_call(env, mr->setNextFile(fd), "java/lang/RuntimeException", "setNextSaveFile failed.");
}
//fengyun add avc package end
...
static JNINativeMethod gMethods[] = {
    ...
    {"native_setup",         "(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;I)V",
                                                                (void *)android_media_MediaRecorder_native_setup},
    {"native_finalize",      "()V",                             (void *)android_media_MediaRecorder_native_finalize},
    {"native_setInputSurface", "(Landroid/view/Surface;)V", (void *)android_media_MediaRecorder_setInputSurface },
    //fengyun add avc package start
    {"_setNextSaveFile",         "(Ljava/io/FileDescriptor;)V",           (void *)android_media_MediaRecorder_setNextSaveFile},
    //fengyun add avc package end
};
