...
class DatabaseHelper extends SQLiteOpenHelper {
	...
	if(key.equals(Settings.System.SCREEN_OFF_TIMEOUT))
	{
		if(mContext.getResources().getInteger(resid) < 0 ) 
		{
			Log.d(TAG,"+++++++++++++++default set Settings.System.SCREEN_OFF_TIMEOUT -1 ++++++++++++");
			loadSetting(stmt, key,Integer.toString(Integer.MAX_VALUE));
		}
		else
			loadSetting(stmt, key,
