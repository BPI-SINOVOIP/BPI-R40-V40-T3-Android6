...
public class AudioService extends IAudioService.Stub {
   ...
   /** Maximum volume index values for audio streams */
    ...
    private final int[] STREAM_VOLUME_ALIAS_VOICE = new int[] {
        ...
        AudioSystem.STREAM_MUSIC,            // STREAM_EXTERNAL
    ...
    private static final int[] STREAM_VOLUME_OPS = new int[] {
        ...
        AppOpsManager.OP_AUDIO_MEDIA_VOLUME,            // STREAM_EXTERNAL
    ...
    private int getDeviceForStream(int stream) {
        ...
        if ((device & (device - 1)) != 0) {
            ...
            } else if ((device & AudioSystem.DEVICE_OUT_EXTERNAL) != 0) {
                device = AudioSystem.DEVICE_OUT_EXTERNAL;
            }else {
