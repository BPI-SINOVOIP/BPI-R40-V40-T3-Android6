        ...
        try {
            switch (config.ipAssignment) {
                ...
                case PPPOE:
                    out.writeUTF(IP_ASSIGNMENT_KEY);
                    out.writeUTF(config.ipAssignment.toString());
                    PppoeConfiguration pppoeConfiguration = config.pppoeConfiguration;
                    if (pppoeConfiguration != null) {
                        if (pppoeConfiguration.username != null) {
                            out.writeUTF(USERNAME_KEY);
                            out.writeUTF(pppoeConfiguration.username);
                        }
                        if (pppoeConfiguration.password != null) {
                            out.writeUTF(PASSWORD_KEY);
                            out.writeUTF(pppoeConfiguration.password);
                        }
                    }
                    written = true;
                    break;
    ...
    public SparseArray<IpConfiguration> readIpAndProxyConfigurations(String filePath) {
        ...
        try {
            ...
            while (true) {
                ...
                PppoeConfiguration pppoeConfiguration = new PppoeConfiguration();
                ...
                do {
                    ...
                    try {
                        if (key.equals(ID_KEY)) {
                            ...
                            if(username != null &&
                                    pppoeConfiguration.username == null) {
                                pppoeConfiguration.username = username;
                            }
                        } else if (key.equals(PASSWORD_KEY)) {
                            String password = in.readUTF();
                            if(password != null &&
                                    pppoeConfiguration.password == null) {
                                pppoeConfiguration.password = password;
                            }
                ...
                if (id != -1) {
                    ...
                    switch (ipAssignment) {
                        ...
                        case DHCP:
                            ...
                            break;
                        case PPPOE:
                            config.pppoeConfiguration = pppoeConfiguration;
                            config.ipAssignment = ipAssignment;
                            break;
                        case UNASSIGNED:
