...
public:
	...
	int onUserStarted(userid_t userId,char *name);
    int onUserStopped(userid_t userId);

    int setPrimary(const std::shared_ptr<android::vold::VolumeBase>& vol);
	int setPrimary(const std::shared_ptr<android::vold::VolumeBase>& vol,int force);
...
private:
	...
	int linkPrimary(userid_t userId,char *name);
