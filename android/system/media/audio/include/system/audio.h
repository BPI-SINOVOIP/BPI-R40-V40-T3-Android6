...
typedef enum {
    ...
    AUDIO_STREAM_DTMF             = 8,
    //AUDIO_STREAM_FM               = 9,  
    AUDIO_STREAM_EXTERNAL      = 9,
    AUDIO_STREAM_TTS              = 10,  /* Transmitted Through Speaker.
...
typedef enum {
    ...
    AUDIO_MODE_FM		= 5,
    AUDIO_MODE_BT_MUSIC  = 6,
    AUDIO_MODE_BT_CALL   = 7,
...
enum {
    ...
    AUDIO_DEVICE_OUT_EXTERNAL                        = 0x1000000,
