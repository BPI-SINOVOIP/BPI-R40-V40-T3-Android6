...
public class Utils {
    ...
    public static final String SERVER_URL_USE_DOMAIN = getString("ro.ota.ip")+"/controller/controller.shtml";
    public static final String SERVER_URL_USE_IP = getString("ro.ota.ip")+"/controller/controller.shtml";
