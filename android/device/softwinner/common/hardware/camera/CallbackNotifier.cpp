...
status_t CallbackNotifier::storeMetaDataInBuffers(__attribute__((unused)) bool enable)
{
...
bool CallbackNotifier::takePicture(const void* frame, void *memOpsS,bool is_continuous)
{
	...
	sjpegInfo.sBaseInfo.memops = (struct ScMemOpsS*)memOpsS ;
	CdcMemOpen(sjpegInfo.sBaseInfo.memops);
