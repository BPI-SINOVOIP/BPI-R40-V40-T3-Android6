...
static struct resource axp15_pek_resources[] = {
	{AXP15_IRQ_PEKLO, AXP15_IRQ_PEKLO, "PEK_LONG",  IORESOURCE_IRQ,},
	{AXP15_IRQ_PEKSH, AXP15_IRQ_PEKSH, "PEK_SHORT", IORESOURCE_IRQ,},
				...
				const struct i2c_device_id *id)
{
	...
	axp_platform_ops_set(&axp15_platform_ops);
