...
//[23:20]: rank disable;1 disable£¬0 enable(Ä¬ÈÏ£©
//[19:16]: DX disable;1 disable£¬0 enable(Ä¬ÈÏ£©

#define DRAM_SDL_ADDR       0x01c62820
/*¸ÃµØÖ·ÓÃÓÚSDL¹¦ÄÜÑéÖ¤
0x820[0]   Ð´1´¥·¢
0x820[15:8] ±àºÅ£º
0x00-0x1F £ºDQ0 -DQ31  wsdl
0x20-0x3F £ºDQ0 -DQ31  rsdl

0x40-0x43 £ºDQS0-DQS3  wsdl
0x44-0x47 £ºDQS0-DQS3  rsdl
0x48-0x4b £ºDQS0#-DQS3#  rsdl
0x4c-0x4f £ºDM0-DM3    wsdl
*/
...
#define MC_MDFS_GPU1_BWLR      	(MCTL_COM_BASE + 0x140)
/*protect register*/
 ...
 * ====================================
 */
#define VDD_SYS_PWROFF_GATING        (0x01F01400 + 0x110)
/*=====================================
 *CPUCFG¼Ä´æÆ÷
 * ====================================
 */
 #define GENER_CTRL_REG        (0x01c25c00 + 0x184)
#endif
